package com.yqq.commonUtils.ThreadUtils;
...
public class ThreadPoolUtils {
   ...
   public static  ExecutorService  getInstance(){
    ...
    /**
     * 从线程池中抽取线程，执行指定的Runnable对象 并且返回String 类型结果
     * @param runnable
     */
    public static String submit(Callable<String> runnable){
        ...
        try {
            ...
            return threadPool.submit(runnable).get();
